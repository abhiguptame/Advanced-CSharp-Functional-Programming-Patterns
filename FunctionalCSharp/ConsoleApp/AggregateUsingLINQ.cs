...
{
    internal class AggregateUsingLINQ
    {
        ...
        public void AggregateRobots()
        {
            ...
            var robot1 = new Robo(name: "Robot1", batteryLevel: 60);
            var robot2 = new Robo(name: "Robot2", batteryLevel: 45);
            var robot3 = new Robo(name: "Robot3", batteryLevel: 95);
            var robot4 = new Robo(name: "Robot4", batteryLevel: 27);

            ImmutableList<Robo> robots = ImmutableList.Create(new Robo[] { robot1, robot2, robot3, robot4 });
    ...
    public class Robo
    {
        ...
        public Robo(string name, int batteryLevel)
        {
            Name = name;
