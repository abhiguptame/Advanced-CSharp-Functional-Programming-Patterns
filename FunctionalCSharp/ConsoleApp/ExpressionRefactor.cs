...
{
    public class ExpressionRefactor
    {
		public void DoWork()
		{
			...
			Console.WriteLine("Sale Price using Statement:" +salePriceA.ToString());

			var salePriceB = GetProductPriceByExpression(product: currentProduct, quantity: 12, isPremiumCustomer: true);
			Console.WriteLine("Sale Price using Expressions:" + salePriceB.ToString());
			Console.ReadLine();
		}
